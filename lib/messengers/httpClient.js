...
HttpMessengerClient.prototype.addEndpoint = HttpMessengerClient.prototype.addRecipient = function (rootHash, url) {
...
HttpMessengerClient.prototype.send = function (rootHash, msg, identityInfo) {
  ...
  return this._doSend(msg, url).then(function (resp) {
